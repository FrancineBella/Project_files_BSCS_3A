...
<body style="background:url(bg3.jpg); background-repeat: no-repeat; background-size:100% 100%">
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    <CENTER><h1>PAYSLIP FORM</h1></CENTER>
 
    <div class="column left">
  <div class="right1">
      <form>
  <fieldset style="width: 775px; background:#D4F0F0;">
    ...
    <input type="text" name="numberofdependents" size="18" value="<?php echo $numberofdependents; ?>"><br><br>
 

    <label for="price">First Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" name="fname" size="25" value="<?php echo $fname; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <input type="text" name="mname" size="25" value="<?php echo $mname; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label for="price">Employee Status:&nbsp;&nbsp;&nbsp;
    <input type="text" name="empstatus" size="25" value="<?php echo $empstatus; ?>"> 
    </label><br><br>

    <label for="price">Surname:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <input type="text" name="sname" size="25" value="<?php echo $sname; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label for="price">Department:&nbsp;&nbsp;
   <input type="text" name="department1" size="28" value="<?php echo $department1; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </label><br><br>

    <label for="price">Civil Status:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" name="civilstatus" size="25" value="<?php echo $civilstatus; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </label>
    ...
    <input type="text" name="designation" size="25" value="<?php echo $designation; ?>">
    </label><br>
    </label>
</fieldset>
</div>
...
<p class="box">
  <img src="pro.png" alt="image" width="200" height="250">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class=regular>
  <fieldset style="background:#D4F0F0;">
...
<CENTER> <button class="button6">EXIT</button></CENTER></div>
</div>
</div>
