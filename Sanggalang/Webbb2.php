...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <body style="background-color: orange">
    ...
    <ul>
      ...
      <li><a href="Webbb2.php">Payslip form</a></li>
      <li><a href="Webpage3.php">Point of sale</a></li>
      <li id="contact"><a href="#">Log Out</a></li>
    </ul>
  </header>
</head>
...
<body style="background:#8FCACA;">
    ...
    <div class="column left">
        <div class="right1">
            ...
            <center><u><h4>EMPLOYEE'S PERSONAL INFORMATION</h4></u></center>
    ...
    <p class="box">
        <img src="woman.png" alt="image" width="250" height="250">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button>Browse image</button><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
